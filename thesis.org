...
Impure imaginary programming is prompt
engineering. It is the basis for 'magic' services such as GitHub Copilot. This
burgeoning programming paradigm is about to be
superseded by prompt-tuning and the fine-tuning of language models which will further
occlude the way that software works. Prompt-tuning still results in prompts still imaginary programming.
