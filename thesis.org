...
software. It's a step up and traversing this
multidimensional space is as easy as writing
code pre-GPT. So downplaying how
transformative GPT is is a bit naive. While
being hung up on whether or not GPT is
