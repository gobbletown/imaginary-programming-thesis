...
** Supporting idea - projecting the code back to the starting LM
- Semantic search on existing documents
- Semantic search on existing features of emacs
...
I thought of the final piece 

So your code might take a trip through someone
else's LM along the way and be projected back
to your own.

Guess that means that some of the logic is
completely obscured and you have to make
assumptions.

And then you make a user interface or program
in collaboration with others and since that
code can't be fully understood by one person
because of the veil I guess then you are kinda
compelled to imagine in order to create
something useful.
...
transformer models and have to just start
using them I guess.

I guess neverending story also influenced my
thoughts.

Once everyone stops believing in Fantasia it
ceases to exist.

As does the utility of imaginary code.