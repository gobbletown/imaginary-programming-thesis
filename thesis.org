...
imagination. I will attempt to formalise
...
original license or the spirit of it if the original code was part of the training data
of a neural network alongside software of other conflicting licenses and in mixing  effectively relicences the
same software.
...
** New types of languages are required to work with language models
*** Example-oriented
#+BEGIN_SRC emacs-lisp -n :async :results verbatim code
