...
A demonstration of backtranslation:
...
#+BEGIN_SRC emacs-lisp -n :async :results code raw
  (car (pf-translate-from-world-language-x-to-y "French" "English" "Bon anniversaire\nA vous" :no-select-result t))
#+END_SRC
...
One useful utility of impure imaginary functions is translation.
