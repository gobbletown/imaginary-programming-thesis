...
language and the extrapolation/continuation of
language. Language permeates society and
software. It makes for a big step forward in
the domains of NLP and software engineering
and traversing this multidimensional space is
as easy as writing code pre-GPT. So
downplaying how transformative GPT is a bit
naive. While being hung up on whether or not
GPT is 'intelligent', it's automating whatever
