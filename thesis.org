...
perform useful tasks. LMs such as GPT-3 are
NLP generalists and only require a tiny amount
of prompt design and/or fine-tuning to direct
the LM to perform the NLP task you want via
prompting.
